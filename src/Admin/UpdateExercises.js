...
class UpdateExercises extends Component {
    ...
    componentDidMount(){
        ...
        .then((res)=>{
               console.log(res.data.title)
                ...
                this.setState(Object.assign(this.state.exercises,{ First_Exercise:res.data.exercises.First_Exercise,
                    Second_Exercise:res.data.exercises.Second_Exercise,
                    Third_Exercise:res.data.exercises.Third_Exercise,
                    Fourth_Exercise:res.data.exercises.Fourth_Exercise,
                    Fifth_Exercise:res.data.exercises.Fifth_Exercise,
                    Sixth_Exercise:res.data.exercises.Sixth_Exercise
                }))     
                
                this.setState(Object.assign(this.state.description,{ First_Description:res.data.description.First_Description,
                    Second_Description:res.data.description.Second_Description,
                    Third_Description:res.data.description.Third_Description,
                    Fourth_Description:res.data.description.Fourth_Description,
                    Fifth_Description:res.data.description.Fifth_Description,
                    Sixth_Description:res.data.description.Sixth_Description,
                   }))  

                 
                this.setState(Object.assign(this.state.sets,{ First_ExerciseSets:res.data.sets.FirstExercise_Sets,
                
                    Second_ExerciseSets:res.data.sets.SecondExercise_Sets,
                    Third_ExerciseSets:res.data.sets.ThirdExercise_Sets,
                    Fourth_ExerciseSets:res.data.sets.FourthExercise_Sets,
                    Fifth_ExerciseSets:res.data.sets.FifthExercise_Sets,
                    Sixth_ExerciseSets:res.data.sets.SixthExercise_Sets
                
                  }))   // we need to make copy of abject as objects are pass by reference, so , here we first make copy by using object.assign and then pass value to it
             
                this.setState(Object.assign(this.state.reps,{First_ExerciseReps:res.data.reps.FirstExercise_Reps,
                    
                    Second_ExerciseReps:res.data.reps.SecondExercise_Reps,
                    Third_ExerciseReps:res.data.reps.ThirdExercise_Reps,
                    Fourth_ExerciseReps:res.data.reps.FourthExercise_Reps,
                    Fifth_ExerciseReps:res.data.reps.FifthExercise_Reps,
                    Sixth_ExerciseReps:res.data.reps.SixthExercise_Reps
   ...
   onSubmit(e){
     ...
     axios.post('http://localhost:8000/exercises/'+this.props.match.params.id , ExerciseSet) // to connect front end to backend "we write backend api"
               .then(
                     (res) => { alert("Exercise Update Successfully ") 
                                }                )
    ...
    render() {
        return (
            <div>
                <h1 className="text-center">Update Your Exercises</h1>
